...
UPDATE `mapRegions` SET `ratFactionID` = 500022 WHERE `regionID` = 10000013;
...
UPDATE `mapRegions` SET `ratFactionID` = 500022 WHERE `regionID` = 10000018;
UPDATE `mapRegions` SET `ratFactionID` = 500022 WHERE `regionID` = 10000019;
UPDATE `mapRegions` SET `ratFactionID` = 500019 WHERE `regionID` = 10000020;
UPDATE `mapRegions` SET `ratFactionID` = 500022 WHERE `regionID` = 10000021;
...
UPDATE `mapRegions` SET `ratFactionID` = 500022 WHERE `regionID` = 10000027;
...
UPDATE `mapRegions` SET `ratFactionID` = 500022 WHERE `regionID` = 10000034;
...
UPDATE `mapRegions` SET `ratFactionID` = 500022 WHERE `regionID` = 10000040;
...
UPDATE `mapRegions` SET `ratFactionID` = 500022 WHERE `regionID` = 10000053;
...
UPDATE `mapRegions` SET `ratFactionID` = 500022 WHERE `regionID` = 10000066;
...
-- correct unescaped quote on sleeper NNA
UPDATE `invTypes` SET `description` = 'Even millennium old, this bulky piece of equipment shows barely any sign of age. The explosion of the Sleeper drone ferrying it around doesn\\''t seem to have affected it in any way, either. This device was clearly built to last. A cursory analysis of the software systems within reveals that it operates as some kind of monitoring device. The specialized design suggests it was used to process vast amounts of basic data and identify anomalies. Given its age and unique design, there would likely be very few who could make sense of the programming. Those who do recognize the value of such a component, however, would likely be willing to part with a significant sum of ISK to own it. ' WHERE `invTypes`.`typeID` = 30744;
