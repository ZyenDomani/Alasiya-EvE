...
DROP TABLE IF EXISTS `crpLabels`;
...
--
-- Dumping data for table `crpLabels`
--

LOCK TABLES `crpLabels` WRITE;
/*!40000 ALTER TABLE `crpLabels` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpLabels` ENABLE KEYS */;
UNLOCK TABLES;
