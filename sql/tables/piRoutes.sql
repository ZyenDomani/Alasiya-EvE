...
--
-- Dumping data for table `piRoutes`
--

LOCK TABLES `piRoutes` WRITE;
/*!40000 ALTER TABLE `piRoutes` DISABLE KEYS */;
/*!40000 ALTER TABLE `piRoutes` ENABLE KEYS */;
UNLOCK TABLES;
