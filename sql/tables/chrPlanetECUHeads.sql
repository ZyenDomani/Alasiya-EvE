...
--
-- Table structure for table `chrPlanetECUHeads`
--

DROP TABLE IF EXISTS `chrPlanetECUHeads`;
...
--
-- Dumping data for table `chrPlanetECUHeads`
--

LOCK TABLES `chrPlanetECUHeads` WRITE;
/*!40000 ALTER TABLE `chrPlanetECUHeads` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrPlanetECUHeads` ENABLE KEYS */;
UNLOCK TABLES;
