...
DROP TABLE IF EXISTS `alnContacts`;
...
--
-- Dumping data for table `alnContacts`
--

LOCK TABLES `alnContacts` WRITE;
/*!40000 ALTER TABLE `alnContacts` DISABLE KEYS */;
/*!40000 ALTER TABLE `alnContacts` ENABLE KEYS */;
UNLOCK TABLES;
