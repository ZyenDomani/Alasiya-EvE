...
--
-- Dumping data for table `crpCharShares`
--

LOCK TABLES `crpCharShares` WRITE;
/*!40000 ALTER TABLE `crpCharShares` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpCharShares` ENABLE KEYS */;
UNLOCK TABLES;
