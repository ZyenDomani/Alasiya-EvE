...
--
-- Dumping data for table `srvStatisticData`
--

LOCK TABLES `srvStatisticData` WRITE;
/*!40000 ALTER TABLE `srvStatisticData` DISABLE KEYS */;
/*!40000 ALTER TABLE `srvStatisticData` ENABLE KEYS */;
UNLOCK TABLES;
