...
--
-- Dumping data for table `chrApplications`
--

LOCK TABLES `chrApplications` WRITE;
/*!40000 ALTER TABLE `chrApplications` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrApplications` ENABLE KEYS */;
UNLOCK TABLES;
