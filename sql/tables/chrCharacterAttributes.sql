...
DROP TABLE IF EXISTS `chrCharacterAttributes`;
...
--
-- Dumping data for table `chrCharacterAttributes`
--

LOCK TABLES `chrCharacterAttributes` WRITE;
/*!40000 ALTER TABLE `chrCharacterAttributes` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrCharacterAttributes` ENABLE KEYS */;
UNLOCK TABLES;
