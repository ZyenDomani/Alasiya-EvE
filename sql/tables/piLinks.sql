...
--
-- Dumping data for table `piLinks`
--

LOCK TABLES `piLinks` WRITE;
/*!40000 ALTER TABLE `piLinks` DISABLE KEYS */;
/*!40000 ALTER TABLE `piLinks` ENABLE KEYS */;
UNLOCK TABLES;
