...
DROP TABLE IF EXISTS `alnLabels`;
...
--
-- Dumping data for table `alnLabels`
--

LOCK TABLES `alnLabels` WRITE;
/*!40000 ALTER TABLE `alnLabels` DISABLE KEYS */;
/*!40000 ALTER TABLE `alnLabels` ENABLE KEYS */;
UNLOCK TABLES;
