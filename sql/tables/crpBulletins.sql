...
DROP TABLE IF EXISTS `crpBulletins`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `crpBulletins` (
  `bulletinID` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Corporation Bulletin Data';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `crpBulletins`
--

LOCK TABLES `crpBulletins` WRITE;
/*!40000 ALTER TABLE `crpBulletins` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpBulletins` ENABLE KEYS */;
UNLOCK TABLES;
