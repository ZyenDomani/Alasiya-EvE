...
--
-- Dumping data for table `dunEntryData`
--

LOCK TABLES `dunEntryData` WRITE;
/*!40000 ALTER TABLE `dunEntryData` DISABLE KEYS */;
/*!40000 ALTER TABLE `dunEntryData` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-05-14 22:47:40
