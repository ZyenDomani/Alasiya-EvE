...
DROP TABLE IF EXISTS `crpItemEvent`;
...
CREATE TABLE `crpItemEvent` (
  ...
  PRIMARY KEY (`eventID`),
  UNIQUE KEY `id_2` (`eventID`),
  KEY `id` (`eventID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Event History logging for Corp AuditMember';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `crpItemEvent`
--

LOCK TABLES `crpItemEvent` WRITE;
/*!40000 ALTER TABLE `crpItemEvent` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpItemEvent` ENABLE KEYS */;
UNLOCK TABLES;
