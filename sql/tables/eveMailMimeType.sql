...
--
-- Dumping data for table `eveMailMimeType`
--

LOCK TABLES `eveMailMimeType` WRITE;
/*!40000 ALTER TABLE `eveMailMimeType` DISABLE KEYS */;
INSERT INTO `eveMailMimeType` VALUES (1,'text/plain',0);
/*!40000 ALTER TABLE `eveMailMimeType` ENABLE KEYS */;
UNLOCK TABLES;
