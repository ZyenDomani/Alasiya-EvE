...
--
-- Table structure for table `chrPlanetLinks`
--

DROP TABLE IF EXISTS `chrPlanetLinks`;
...
--
-- Dumping data for table `chrPlanetLinks`
--

LOCK TABLES `chrPlanetLinks` WRITE;
/*!40000 ALTER TABLE `chrPlanetLinks` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrPlanetLinks` ENABLE KEYS */;
UNLOCK TABLES;
