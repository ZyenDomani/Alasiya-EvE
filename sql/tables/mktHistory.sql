...
DROP TABLE IF EXISTS `mktHistory`;
...
--
-- Dumping data for table `mktHistory`
--

LOCK TABLES `mktHistory` WRITE;
/*!40000 ALTER TABLE `mktHistory` DISABLE KEYS */;
/*!40000 ALTER TABLE `mktHistory` ENABLE KEYS */;
UNLOCK TABLES;
