...
DROP TABLE IF EXISTS `webBounties`;
...
--
-- Dumping data for table `webBounties`
--

LOCK TABLES `webBounties` WRITE;
/*!40000 ALTER TABLE `webBounties` DISABLE KEYS */;
/*!40000 ALTER TABLE `webBounties` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-07-29 20:02:58
