...
--
-- Dumping data for table `mktTransactions`
--

LOCK TABLES `mktTransactions` WRITE;
/*!40000 ALTER TABLE `mktTransactions` DISABLE KEYS */;
/*!40000 ALTER TABLE `mktTransactions` ENABLE KEYS */;
UNLOCK TABLES;
