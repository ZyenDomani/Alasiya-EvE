...
--
-- Dumping data for table `chrOwnerNote`
--

LOCK TABLES `chrOwnerNote` WRITE;
/*!40000 ALTER TABLE `chrOwnerNote` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrOwnerNote` ENABLE KEYS */;
UNLOCK TABLES;
