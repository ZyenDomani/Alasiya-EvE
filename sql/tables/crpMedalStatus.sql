...
LOCK TABLES `crpMedalStatus` WRITE;
/*!40000 ALTER TABLE `crpMedalStatus` DISABLE KEYS */;
INSERT INTO `crpMedalStatus` VALUES (1,0,'invalid'),(2,1,'Remove'),(3,2,'Private'),(4,3,'Public');
/*!40000 ALTER TABLE `crpMedalStatus` ENABLE KEYS */;
UNLOCK TABLES;
