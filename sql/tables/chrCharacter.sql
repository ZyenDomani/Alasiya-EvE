...
CREATE TABLE `chrCharacter` (
  ...
  `logonMinutes` int(10)  NOT NULL DEFAULT '0',
  `skillPoints` double NOT NULL DEFAULT '0',
  `skillQueueEndTime` bigint(20)  NOT NULL DEFAULT '0',
  `corporationID` int(10)  NOT NULL DEFAULT '0',
  `corpAccountKey` smallint(4) NOT NULL DEFAULT '0',
  `corpRole` bigint(20)  NOT NULL DEFAULT '0',
  `rolesAtAll` bigint(20)  NOT NULL DEFAULT '0',
  ...
  `ancestryID` int(10)  NOT NULL DEFAULT '0',
  `bloodlineID` tinyint(3)  NOT NULL DEFAULT '0',
  `raceID` tinyint(3)  NOT NULL DEFAULT '0',
  `careerID` int(10)  NOT NULL DEFAULT '0',
  `schoolID` int(10)  NOT NULL DEFAULT '0',
  `careerSpecialityID` int(10)  NOT NULL DEFAULT '0',
  ...
  `freeRespecs` tinyint(1)  NOT NULL DEFAULT '0',
  `lastRespecDateTime` bigint(20)  NOT NULL DEFAULT '0',
  `nextRespecDateTime` bigint(20)  NOT NULL DEFAULT '0',
  `deletePrepareDateTime` bigint(20)  DEFAULT '0',
