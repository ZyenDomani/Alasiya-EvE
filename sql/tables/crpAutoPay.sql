...
DROP TABLE IF EXISTS `crpAutoPay`;
...
CREATE TABLE `crpAutoPay` (
  ...
  `sov` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`corporationID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `crpAutoPay`
--

LOCK TABLES `crpAutoPay` WRITE;
/*!40000 ALTER TABLE `crpAutoPay` DISABLE KEYS */;
INSERT INTO `crpAutoPay` VALUES (98000001,0,0,0,0,0,0);
/*!40000 ALTER TABLE `crpAutoPay` ENABLE KEYS */;
UNLOCK TABLES;
