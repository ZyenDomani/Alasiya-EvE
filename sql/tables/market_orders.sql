...
CREATE TABLE `market_orders` (
  ...
  `orderRange` int(10)  NOT NULL DEFAULT '0',
  `bid` tinyint(3)  NOT NULL DEFAULT '0',
  `price` double NOT NULL DEFAULT '0',
  `volEntered` int(10)  NOT NULL DEFAULT '0',
  `volRemaining` int(10)  NOT NULL DEFAULT '0',
  `issued` bigint(20)  NOT NULL DEFAULT '0',
  `orderState` int(10)  NOT NULL DEFAULT '0',
  `minVolume` int(10)  NOT NULL DEFAULT '0',
  `contraband` tinyint(3)  NOT NULL DEFAULT '0',
  `accountID` int(10)  NOT NULL DEFAULT '0',
  `duration` int(10)  NOT NULL DEFAULT '0',
  `isCorp` tinyint(3)  NOT NULL DEFAULT '0',
  `solarSystemID` int(11) NOT NULL DEFAULT '0',
  `escrow` tinyint(3)  NOT NULL DEFAULT '0',
