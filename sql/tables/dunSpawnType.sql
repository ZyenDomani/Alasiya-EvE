...
--
-- Dumping data for table `dunSpawnType`
--

LOCK TABLES `dunSpawnType` WRITE;
/*!40000 ALTER TABLE `dunSpawnType` DISABLE KEYS */;
/*!40000 ALTER TABLE `dunSpawnType` ENABLE KEYS */;
UNLOCK TABLES;
