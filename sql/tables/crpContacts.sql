...
DROP TABLE IF EXISTS `crpContacts`;
...
--
-- Dumping data for table `crpContacts`
--

LOCK TABLES `crpContacts` WRITE;
/*!40000 ALTER TABLE `crpContacts` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpContacts` ENABLE KEYS */;
UNLOCK TABLES;
