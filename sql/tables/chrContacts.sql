...
DROP TABLE IF EXISTS `chrContacts`;
...
--
-- Dumping data for table `chrContacts`
--

LOCK TABLES `chrContacts` WRITE;
/*!40000 ALTER TABLE `chrContacts` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrContacts` ENABLE KEYS */;
UNLOCK TABLES;
