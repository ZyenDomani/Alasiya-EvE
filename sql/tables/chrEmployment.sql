...
--
-- Dumping data for table `chrEmployment`
--

LOCK TABLES `chrEmployment` WRITE;
/*!40000 ALTER TABLE `chrEmployment` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrEmployment` ENABLE KEYS */;
UNLOCK TABLES;
