...
CREATE TABLE `crpShares` (
  ...
  PRIMARY KEY (`id`,`shareholderID`),
  KEY `shareholderID` (`shareholderID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `crpShares`
--

LOCK TABLES `crpShares` WRITE;
/*!40000 ALTER TABLE `crpShares` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpShares` ENABLE KEYS */;
UNLOCK TABLES;
