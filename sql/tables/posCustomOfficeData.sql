...
--
-- Table structure for table `posCustomOfficeData`
--

DROP TABLE IF EXISTS `posCustomOfficeData`;
...
--
-- Dumping data for table `posCustomOfficeData`
--

LOCK TABLES `posCustomOfficeData` WRITE;
/*!40000 ALTER TABLE `posCustomOfficeData` DISABLE KEYS */;
/*!40000 ALTER TABLE `posCustomOfficeData` ENABLE KEYS */;
UNLOCK TABLES;
