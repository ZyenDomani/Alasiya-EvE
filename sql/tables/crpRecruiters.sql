...
DROP TABLE IF EXISTS `crpRecruiters`;
...
--
-- Dumping data for table `crpRecruiters`
--

LOCK TABLES `crpRecruiters` WRITE;
/*!40000 ALTER TABLE `crpRecruiters` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpRecruiters` ENABLE KEYS */;
UNLOCK TABLES;
