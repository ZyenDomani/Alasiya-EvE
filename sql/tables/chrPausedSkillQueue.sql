...
DROP TABLE IF EXISTS `chrPausedSkillQueue`;
...
--
-- Dumping data for table `chrPausedSkillQueue`
--

LOCK TABLES `chrPausedSkillQueue` WRITE;
/*!40000 ALTER TABLE `chrPausedSkillQueue` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrPausedSkillQueue` ENABLE KEYS */;
UNLOCK TABLES;
