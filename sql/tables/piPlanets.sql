...
DROP TABLE IF EXISTS `piPlanets`;
...
--
-- Dumping data for table `piPlanets`
--

LOCK TABLES `piPlanets` WRITE;
/*!40000 ALTER TABLE `piPlanets` DISABLE KEYS */;
/*!40000 ALTER TABLE `piPlanets` ENABLE KEYS */;
UNLOCK TABLES;
