...
DROP TABLE IF EXISTS `shipInsurance`;
...
--
-- Dumping data for table `shipInsurance`
--

LOCK TABLES `shipInsurance` WRITE;
/*!40000 ALTER TABLE `shipInsurance` DISABLE KEYS */;
/*!40000 ALTER TABLE `shipInsurance` ENABLE KEYS */;
UNLOCK TABLES;
