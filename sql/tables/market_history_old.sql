...
--
-- Dumping data for table `market_history_old`
--

LOCK TABLES `market_history_old` WRITE;
/*!40000 ALTER TABLE `market_history_old` DISABLE KEYS */;
/*!40000 ALTER TABLE `market_history_old` ENABLE KEYS */;
UNLOCK TABLES;
