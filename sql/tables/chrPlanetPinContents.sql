...
--
-- Table structure for table `chrPlanetPinContents`
--

DROP TABLE IF EXISTS `chrPlanetPinContents`;
...
--
-- Dumping data for table `chrPlanetPinContents`
--

LOCK TABLES `chrPlanetPinContents` WRITE;
/*!40000 ALTER TABLE `chrPlanetPinContents` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrPlanetPinContents` ENABLE KEYS */;
UNLOCK TABLES;
