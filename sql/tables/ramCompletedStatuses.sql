...
--
-- Dumping data for table `ramCompletedStatuses`
--

LOCK TABLES `ramCompletedStatuses` WRITE;
/*!40000 ALTER TABLE `ramCompletedStatuses` DISABLE KEYS */;
INSERT INTO `ramCompletedStatuses` VALUES (0,'Failed',''),(1,'Delivered',''),(2,'Aborted',''),(3,'GM aborted',''),(4,'Unanchored',''),(5,'Destroyed','');
/*!40000 ALTER TABLE `ramCompletedStatuses` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-05-14 22:48:06
