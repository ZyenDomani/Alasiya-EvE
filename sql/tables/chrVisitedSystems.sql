...
DROP TABLE IF EXISTS `chrVisitedSystems`;
...
--
-- Dumping data for table `chrVisitedSystems`
--

LOCK TABLES `chrVisitedSystems` WRITE;
/*!40000 ALTER TABLE `chrVisitedSystems` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrVisitedSystems` ENABLE KEYS */;
UNLOCK TABLES;
