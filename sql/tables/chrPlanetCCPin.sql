...
--
-- Table structure for table `chrPlanetCCPin`
--

DROP TABLE IF EXISTS `chrPlanetCCPin`;
...
--
-- Dumping data for table `chrPlanetCCPin`
--

LOCK TABLES `chrPlanetCCPin` WRITE;
/*!40000 ALTER TABLE `chrPlanetCCPin` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrPlanetCCPin` ENABLE KEYS */;
UNLOCK TABLES;
