...
DROP TABLE IF EXISTS `jnlCharacters`;
...
LOCK TABLES `jnlCharacters` WRITE;
/*!40000 ALTER TABLE `jnlCharacters` DISABLE KEYS */;
/*!40000 ALTER TABLE `jnlCharacters` ENABLE KEYS */;
UNLOCK TABLES;
