...
--
-- Table structure for table `chrPlanets`
--

DROP TABLE IF EXISTS `chrPlanets`;
...
--
-- Dumping data for table `chrPlanets`
--

LOCK TABLES `chrPlanets` WRITE;
/*!40000 ALTER TABLE `chrPlanets` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrPlanets` ENABLE KEYS */;
UNLOCK TABLES;
