...
--
-- Table structure for table `chrPlanetRoutes`
--

DROP TABLE IF EXISTS `chrPlanetRoutes`;
...
--
-- Dumping data for table `chrPlanetRoutes`
--

LOCK TABLES `chrPlanetRoutes` WRITE;
/*!40000 ALTER TABLE `chrPlanetRoutes` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrPlanetRoutes` ENABLE KEYS */;
UNLOCK TABLES;
