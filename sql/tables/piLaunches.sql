...
DROP TABLE IF EXISTS `piLaunches`;
...
--
-- Dumping data for table `piLaunches`
--

LOCK TABLES `piLaunches` WRITE;
/*!40000 ALTER TABLE `piLaunches` DISABLE KEYS */;
/*!40000 ALTER TABLE `piLaunches` ENABLE KEYS */;
UNLOCK TABLES;
