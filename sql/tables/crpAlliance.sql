...
DROP TABLE IF EXISTS `crpAlliance`;
...
--
-- Dumping data for table `crpAlliance`
--

LOCK TABLES `crpAlliance` WRITE;
/*!40000 ALTER TABLE `crpAlliance` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpAlliance` ENABLE KEYS */;
UNLOCK TABLES;
