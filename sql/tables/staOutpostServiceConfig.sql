...
--
-- Table structure for table `staOutpostServiceConfig`
--

DROP TABLE IF EXISTS `staOutpostServiceConfig`;
...
--
-- Dumping data for table `staOutpostServiceConfig`
--

LOCK TABLES `staOutpostServiceConfig` WRITE;
/*!40000 ALTER TABLE `staOutpostServiceConfig` DISABLE KEYS */;
/*!40000 ALTER TABLE `staOutpostServiceConfig` ENABLE KEYS */;
UNLOCK TABLES;
