...
--
-- Dumping data for table `bookmarkFolders`
--

LOCK TABLES `bookmarkFolders` WRITE;
/*!40000 ALTER TABLE `bookmarkFolders` DISABLE KEYS */;
/*!40000 ALTER TABLE `bookmarkFolders` ENABLE KEYS */;
UNLOCK TABLES;
