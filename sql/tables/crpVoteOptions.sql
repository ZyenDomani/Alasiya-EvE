...
--
-- Dumping data for table `crpVoteOptions`
--

LOCK TABLES `crpVoteOptions` WRITE;
/*!40000 ALTER TABLE `crpVoteOptions` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpVoteOptions` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-08-01  9:55:15
