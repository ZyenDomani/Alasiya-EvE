...
(26, 2147483648, 'roleAccountCanTake5', 'Account Take [5]', 60199, 'Can take funds from this divisions account', 60151),
(27, 4294967296, 'roleAccountCanTake6', 'Account Take [6]', 60200, 'Can take funds from this divisions account', 60152),
(28, 8589934592, 'roleAccountCanTake7', 'Account Take [7]', 60201, 'Can take funds from this divisions account', 60153),
(29, 17179869184, 'roleDiplomat', 'Diplomat', 60202, 'Can set standings for the corporation.', 60154),
(36, 2199023255552, 'roleEquipmentConfig', 'Config Equipment', 60203, 'Can deploy and configure equipment in space.', 60155),
(37, 4398046511104, 'roleContainerCanTake1', 'Container Take [1]', 60204, 'Can take containers from this divisional hangar', 60156),
(38, 8796093022208, 'roleContainerCanTake2', 'Container Take [2]', 60205, 'Can take containers from this divisional hangar', 60157),
(39, 17592186044416, 'roleContainerCanTake3', 'Container Take [3]', 60206, 'Can take containers from this divisional hangar', 60158),
(40, 35184372088832, 'roleContainerCanTake4', 'Container Take [4]', 60207, 'Can take containers from this divisional hangar', 60159),
(41, 70368744177664, 'roleContainerCanTake5', 'Container Take [5]', 60208, 'Can take containers from this divisional hangar', 60160),
(42, 140737488355328, 'roleContainerCanTake6', 'Container Take [6]', 60209, 'Can take containers from this divisional hangar', 60161),
(43, 281474976710656, 'roleContainerCanTake7', 'Container Take [7]', 60210, 'Can take containers from this divisional hangar', 60162),
(44, 562949953421312, 'roleCanRentOffice', 'Rent Office', 60211, 'When assigned to a member, the member can rent offices on behalf of the corporation', 60163),
(45, 1125899906842624, 'roleCanRentFactorySlot', 'Rent Factory Slot', 60212, 'When assigned to a member, the member can rent factory slots on behalf of the corporation', 60164),
(46, 2251799813685248, 'roleCanRentResearchSlot', 'Rent Research Slot', 60213, 'When assigned to a member, the member can rent research facilities on behalf of the corporation', 60165),
(47, 4503599627370496, 'roleJuniorAccountant', 'Junior Accountant', 60214, 'Can view corporation accountancy info.', 60166),
(48, 9007199254740992, 'roleStarbaseConfig', 'Config Starbase Equipment', 60215, 'Can deploy and configure starbase structures in space.', 60167),
(49, 18014398509481984, 'roleTrader', 'Trader', 60216, 'Can buy and sell things for the corporation', 60168),
(50, 36028797018963968, 'roleChatManager', 'Communications Officer', 60217, 'Can moderate corporation/alliance communications channels', 60169),
(51, 72057594037927936, 'roleContractManager', 'Contract Manager', 60218, 'Can create, edit and oversee all contracts made on behalf of the corportation as well as accept contracts on behalf of the corpora', 60170),
(52, 144115188075855872, 'roleInfrastructureTacticalOfficer', 'Starbase Defense Operator', 60219, 'Can operate defensive starbase structures', 60171),
(53, 288230376151711744, 'roleStarbaseCaretaker', 'Starbase Fuel Technician', 60220, 'Can refuel starbases and take from silo bins', 60172),
(54, 576460752303423488, 'roleFittingManager', 'Fitting Manager', 60221, 'Can add and delete fittings', 60173);
