...
--
-- Table structure for table `srvStatisticDataHistory`
--

DROP TABLE IF EXISTS `srvStatisticDataHistory`;
...
--
-- Dumping data for table `srvStatisticDataHistory`
--

LOCK TABLES `srvStatisticDataHistory` WRITE;
/*!40000 ALTER TABLE `srvStatisticDataHistory` DISABLE KEYS */;
/*!40000 ALTER TABLE `srvStatisticDataHistory` ENABLE KEYS */;
UNLOCK TABLES;
