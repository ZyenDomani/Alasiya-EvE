...
DROP TABLE IF EXISTS `chrShipFittings`;
...
--
-- Dumping data for table `chrShipFittings`
--

LOCK TABLES `chrShipFittings` WRITE;
/*!40000 ALTER TABLE `chrShipFittings` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrShipFittings` ENABLE KEYS */;
UNLOCK TABLES;
