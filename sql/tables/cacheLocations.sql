...
--
-- Dumping data for table `cacheLocations`
--

LOCK TABLES `cacheLocations` WRITE;
/*!40000 ALTER TABLE `cacheLocations` DISABLE KEYS */;
/*!40000 ALTER TABLE `cacheLocations` ENABLE KEYS */;
UNLOCK TABLES;
