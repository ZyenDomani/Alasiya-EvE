...
--
-- Dumping data for table `invBlueprints`
--

LOCK TABLES `invBlueprints` WRITE;
/*!40000 ALTER TABLE `invBlueprints` DISABLE KEYS */;
/*!40000 ALTER TABLE `invBlueprints` ENABLE KEYS */;
UNLOCK TABLES;
