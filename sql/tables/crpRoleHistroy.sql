...
DROP TABLE IF EXISTS `crpRoleHistroy`;
...
--
-- Dumping data for table `crpRoleHistroy`
--

LOCK TABLES `crpRoleHistroy` WRITE;
/*!40000 ALTER TABLE `crpRoleHistroy` DISABLE KEYS */;
/*!40000 ALTER TABLE `crpRoleHistroy` ENABLE KEYS */;
UNLOCK TABLES;
