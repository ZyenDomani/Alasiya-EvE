...
--
-- Table structure for table `chrPlanetLaunches`
--

DROP TABLE IF EXISTS `chrPlanetLaunches`;
...
--
-- Dumping data for table `chrPlanetLaunches`
--

LOCK TABLES `chrPlanetLaunches` WRITE;
/*!40000 ALTER TABLE `chrPlanetLaunches` DISABLE KEYS */;
/*!40000 ALTER TABLE `chrPlanetLaunches` ENABLE KEYS */;
UNLOCK TABLES;
