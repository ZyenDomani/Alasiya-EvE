...
--
-- Dumping data for table `billsPayable`
--

LOCK TABLES `billsPayable` WRITE;
/*!40000 ALTER TABLE `billsPayable` DISABLE KEYS */;
/*!40000 ALTER TABLE `billsPayable` ENABLE KEYS */;
UNLOCK TABLES;
