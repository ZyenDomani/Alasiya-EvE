...
--
-- Dumping data for table `sysCalendarInvitees`
--

LOCK TABLES `sysCalendarInvitees` WRITE;
/*!40000 ALTER TABLE `sysCalendarInvitees` DISABLE KEYS */;
/*!40000 ALTER TABLE `sysCalendarInvitees` ENABLE KEYS */;
UNLOCK TABLES;
