...
PyResult MailingListMgrService::Handle_Create(PyCallArgs& call)
{
    ...
    {
        _log(SERVICE__ERROR, "Failed to decode Create(MailingList) args");
        return nullptr;
    }
...
PyResult MailingListMgrService::Handle_Join(PyCallArgs& call)
{
    ...
    if(!args.Decode(&call.tuple)) {
        _log(SERVICE__ERROR, "Failed to decode Join args");
        return nullptr;
    }
...
PyResult MailingListMgrService::Handle_Delete(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode Delete args");
        return nullptr;
    }
...
PyResult MailingListMgrService::Handle_KickMembers(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode KickMembers args");
        return nullptr;
    }
...
PyResult MailingListMgrService::Handle_GetMembers(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode GetMembers args");
        return nullptr;
    }
...
PyResult MailingListMgrService::Handle_SetEntityAccess(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode SetEntityAccess args");
        return nullptr;
    }
    // no return values
    return nullptr;
...
PyResult MailingListMgrService::Handle_ClearEntityAccess(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode ClearEntityAccess args");
        return nullptr;
    }
    // no return values
    return nullptr;
...
PyResult MailingListMgrService::Handle_SetMembersMuted(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode SetMembersClear args");
        return nullptr;
    }
    return nullptr;
}
...
PyResult MailingListMgrService::Handle_SetDefaultAccess(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode SetDefaultAccess args");
        return nullptr;
    }
...
PyResult MailingListMgrService::Handle_GetInfo(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode GetInfo args");
        return nullptr;
    }
...
PyResult MailingListMgrService::Handle_GetSettings(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode GetSettings args");
        return nullptr;
    }
...
PyResult MailingListMgrService::Handle_GetWelcomeMail(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode GetWelcomeMail args");
        return nullptr;
    }
...
PyResult MailingListMgrService::Handle_SaveWelcomeMail(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode SaveWelcomeMail args");
        return nullptr;
    }
    return nullptr;
}
...
PyResult MailingListMgrService::Handle_SendWelcomeMail(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode SendWelcomeMail args");
        return nullptr;
    }
    return nullptr;
}
...
PyResult MailingListMgrService::Handle_ClearWelcomeMail(PyCallArgs& call)
{
    ...
    if (!args.Decode(&call.tuple))
    {
        _log(SERVICE__ERROR, "Failed to decode ClearWelcomeMail args");
        return nullptr;
    }
