...
PyResult ContractProxy::Handle_SearchContracts(PyCallArgs &call) {
    ...
    sLog.White( "ContractProxy::Handle_SearchContracts()", "size= %u", call.tuple->size() );
...
PyResult ContractProxy::Handle_CreateContract(PyCallArgs &call) {
    ...
    sLog.White( "ContractProxy::Handle_CreateContract()", "size= %u", call.tuple->size() );
    call.Dump(SERVICE__CALL_DUMP);
...
PyResult ContractProxy::Handle_DeleteContract(PyCallArgs &call) {
    ...
    sLog.White( "ContractProxy::Handle_DeleteContract()", "size= %u", call.tuple->size() );
    call.Dump(SERVICE__CALL_DUMP);
...
PyResult ContractProxy::Handle_GetContract(PyCallArgs &call) {
    ...
    */
    ...
    sLog.White( "ContractProxy::Handle_GetContract()", "size= %u", call.tuple->size() );
    call.Dump(SERVICE__CALL_DUMP);
...
[PyObjectData Name: macho.Notification]
  [PyTuple 6 items]
    ...
    sLog.White( "ContractProxy::Handle_AcceptContract()", "size= %u", call.tuple->size() );
    call.Dump(SERVICE__CALL_DUMP);
...
PyResult ContractProxy::Handle_GetMyExpiredContractList(PyCallArgs &call) {
  sLog.White( "ContractProxy::Handle_GetMyExpiredContractList()", "size= %u", call.tuple->size() );
    call.Dump(SERVICE__CALL_DUMP);
/*
...
PyResult ContractProxy::Handle_NumOutstandingContracts(PyCallArgs &call) {
    sLog.White( "ContractProxy::Handle_NumOutstandingContracts()", "size= %u", call.tuple->size() );
    call.Dump(SERVICE__CALL_DUMP);
    /*
...
PyResult ContractProxy::Handle_GetItemsInStation(PyCallArgs &call) {
    sLog.White( "ContractProxy::Handle_GetItemsInStation()", "size= %u", call.tuple->size() );
    call.Dump(SERVICE__CALL_DUMP);
...
PyResult ContractProxy::Handle_CollectMyPageInfo(PyCallArgs &call) {
    sLog.White( "ContractProxy::Handle_CollectMyPageInfo()", "size= %u", call.tuple->size() );
    call.Dump(SERVICE__CALL_DUMP);
    /*
...
PyResult ContractProxy::Handle_GetContractListForOwner(PyCallArgs &call) {
    sLog.White( "ContractProxy::Handle_GetContractListForOwner()", "size= %u", call.tuple->size() );
    call.Dump(SERVICE__CALL_DUMP);
    /*
     *  client call....
      [PyTuple 2 items]
