...
(236782, `Ah, how lucky I am to see you again!  Then again, luck is an expression for the simple minded, as all occurances can easily be explained with mathematical calculations. Oh what am I rambling about, please have a seat and tell me what is on your mind.`)
...
(135863, 'Good day, {[character]agentID.name}. What can you offer me? ')(135877, 'I knew we could count on you, {[character]player.name}. Please hurry. ')
...
(135895, 'Lollygagger')
(135905, 'Always happy to help, but especially when there's ISK involved. ')(136067, 'Give me something meaningful to do, {[character]agentID.name}. I’m looking for a challenge.')
