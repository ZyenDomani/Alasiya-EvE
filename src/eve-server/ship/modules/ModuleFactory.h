...
#include "armor_modules/ArmorHardener.h"
...
#include "shield_modules/ShieldHardener.h"
...
static GenericModule* ModuleFactory(InventoryItemRef item, ShipItemRef ship)
{
    ...
    if( (item->categoryID() != EVEDB::invCategories::Module) && (item->categoryID() != EVEDB::invCategories::Subsystem) )
    {
        ...
        switch(item->groupID())
        {
            ...
            case EVEDB::invGroups::Damage_Control:                          return (new DamageControl(item, ship)); break;    // Active  -  SELF
            case EVEDB::invGroups::Armor_Repair_Unit:                       return (new ArmorRepairer(item, ship)); break;	 // Active  -  SELF
            case EVEDB::invGroups::Hull_Repair_Unit:                        return (new HullRepairer(item, ship)); break;    // Active  -  SELF
            ...
            case EVEDB::invGroups::Armor_Repair_Projector:                  return (new ArmorTransporter(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Armor_Plating_Energized:                 return (new PassiveModule(item, ship)); break;
            case EVEDB::invGroups::Armor_Hardener:                          return (new ArmorHardener(item, ship)); break;    // Active  -  SELF
            case EVEDB::invGroups::Armor_Reinforcer:                        return (new PassiveModule(item, ship)); break;
            case EVEDB::invGroups::Remote_Hull_Repairer:                    return (new HullTransporter(item, ship)); break;    // Active - external
            ...
            case EVEDB::invGroups::Shield_Booster:                          return (new ShieldBooster(item, ship)); break;    // Active  -  SELF
            case EVEDB::invGroups::Shield_Transporter:                      return (new ShieldTransporter(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Shield_Power_Relay:                      return (new PassiveModule(item, ship)); break;
            case EVEDB::invGroups::Shield_Hardener:                         return (new ShieldHardener(item, ship)); break;    // Active  -  SELF
            ...
            case EVEDB::invGroups::Salvager:                                return (new Salvager(item, ship)); break;    // Active - external
            ...
            case EVEDB::invGroups::Energy_Transfer_Array:                   return (new CapTransfer(item, ship)); break;    // Active - external
            ...
            case EVEDB::invGroups::Warp_Scrambler:                          return (new WarpScrambler(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Stasis_Web:                              return (new Webifier(item, ship)); break;    // Active - external
...
/*  Allan's Updates
 * 20  May 2015     Missiles
 *  7 June 2015     Damage Control Unit
 *  9 June 2015     Hull Repairer
 *  9 June 2015     Shield Booster
 * 12 June 2015     Stasis Webber
 * 12 June 2015     Salvager
 * 13 June 2015     Warp Scrambler
 *
 * 24 December 2015    Implemented Module Effects class which enabled all Actives/Passives/Rigs that affect ship attributes
 */
