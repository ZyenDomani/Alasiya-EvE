/*
    ...
    ------------------------------------------------------------------------------------
    Author:        Luck
    Updates:    Allan   13 March 2017    Implemented TRUE effects class and code that processess and applies all item effect using ccp's data (from dump)
*/
...
static GenericModule* ModuleFactory(InventoryItemRef item, ShipItemRef ship)
{
    ...
    if( (item->categoryID() != EVEDB::invCategories::Module) && (item->categoryID() != EVEDB::invCategories::Subsystem) )
    {
        ...
        switch(item->groupID())
        {
            ...
            case EVEDB::invGroups::Energy_Weapon:                           return (new ActiveModule(item, ship)); break;        // Active - external
            case EVEDB::invGroups::Projectile_Weapon:                       return (new ActiveModule(item, ship)); break;    // Active - external
            ...
            case EVEDB::invGroups::Hybrid_Weapon:                           return (new ActiveModule(item, ship)); break;    // Active - external
            ...
            case EVEDB::invGroups::Missile_Launcher_Snowball:               return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Cruise:                 return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Rocket:                 return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Siege:                  return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Standard:               return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Heavy:                  return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Assault:                return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Defender:               return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Citadel:                return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Heavy_Assault:          return (new ActiveModule(item, ship)); break;    // Active - external
            case EVEDB::invGroups::Missile_Launcher_Bomb:                   return (new ActiveModule(item, ship)); break;    // Active - external

            // Armor Modules Subgroup:
            case EVEDB::invGroups::Damage_Control:                          return (new ActiveModule(item, ship)); break;    // Active  -  SELF
            case EVEDB::invGroups::Armor_Repair_Unit:                       return (new ActiveModule(item, ship)); break;	 // Active  -  SELF
            ...
            case EVEDB::invGroups::Salvager:                                return (new ActiveModule(item, ship)); break;    // Active - external
            ...
            case EVEDB::invGroups::Mining_Laser:                            return (new ActiveModule(item, ship)); break;     // Active - external
            case EVEDB::invGroups::Strip_Miner:                             return (new ActiveModule(item, ship)); break;     // Active - external
            case EVEDB::invGroups::Frequency_Mining_Laser:                  return (new ActiveModule(item, ship)); break;     // Active - external
