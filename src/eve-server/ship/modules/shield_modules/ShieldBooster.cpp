/*
    ...
    ------------------------------------------------------------------------------------
    Author:        Allan
    Copied from Aknor's ArmorRepairer
*/

#include "ship/modules/shield_modules/ShieldBooster.h"


ShieldBooster::ShieldBooster( InventoryItemRef item, ShipItemRef ship )
