 ...
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251870, 'label': u'GettingBonusFromSquadWing'}(u'You are receiving bonuses from:\n<b>Squad Booster</b> and <b>Wing Booster</b>', None, None)
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251871, 'label': u'GettingBonusFromSquadWingFleet'}(u'You are receiving bonuses from:\n<b>Squad Booster</b>, <b>Wing Booster</b> and <b>Fleet Booster</b>', None, None)
 * {'FullPath': u'UI/Shared', 'messageID': 251872, 'label': u'ReadProgress'}(u'{text} ({[numeric] done}/{[numeric] total})', None, {u'{text}': {'conditionalValues': [], 'variableType': 10, 'propertyName': None, 'args': 0, 'kwargs': {}, 'variableName': 'text'}, u'{[numeric] total}': {'conditionalValues': [], 'variableType': 9, 'propertyName': None, 'args': 0, 'kwargs': {}, 'variableName': 'total'}, u'{[numeric] done}': {'conditionalValues': [], 'variableType': 9, 'propertyName': None, 'args': 0, 'kwargs': {}, 'variableName': 'done'}})
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251873, 'label': u'GivingBonusSquad'}(u'Bonuses are applied in this system from <b>Squad Booster</b>', None, None)
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251874, 'label': u'GivingBonusWing'}(u'Bonuses are applied in this system from <b>Wing Booster</b>', None, None)
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251875, 'label': u'GivingBonusFleet'}(u'Bonuses are applied in this system from <b>Fleet Booster</b>', None, None)
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251876, 'label': u'NotGivingBonusSquadNoCmdr'}(u'<b>Not giving bonuses</b>\nYou do not have the Leadership skill to control a squad', None, None)
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251877, 'label': u'NotGivingBonusSquadTooMany'}(u'<b>Not giving bonuses</b>\nYou do not have the necessary skill level to control a squad of this size', None, None)
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251878, 'label': u'NotGivingBonusSquadTooFew'}(u'<b>Not giving bonuses</b>\nA squad must have at least one other member in this system', None, None)
 * {'FullPath': u'UI/InfoWindow', 'messageID': 251879, 'label': u'SystemSettledByCorp'}(u'Settled by {corpName}', None, {u'{corpName}': {'conditionalValues': [], 'variableType': 10, 'propertyName': None, 'args': 0, 'kwargs': {}, 'variableName': 'corpName'}})
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251880, 'label': u'NotGivingBonusWing'}(u'<b>Not giving bonuses</b>\nYou do not have the necessary skill level to control a wing of this size', None, None)
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251881, 'label': u'NotGivingBonusFleetTooMany'}(u'<b>Not giving bonuses</b>\nYou do not have the necessary skill level to control this many active wings in your solar system', None, None)
 * {'FullPath': u'UI/Fleet/FleetWindow', 'messageID': 251882, 'label': u'NotGivingBonusFleetTooFew'}(u'<b>Not giving bonuses</b>\nYou need at least one other member in your fleet in the current system', None, None)
 * 
 */