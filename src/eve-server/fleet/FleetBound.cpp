...
PyResult FleetBound::Handle_AcceptInvite(PyCallArgs &call) {
    sLog.White("FleetBound", "Handle_AcceptInvite() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_RejectInvite(PyCallArgs &call) {
    sLog.White("FleetBound", "Handle_RejectInvite() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_ChangeWingName(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_ChangeWingName() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_ChangeSquadName(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_ChangeSquadName() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_SetOptions(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_SetOptions() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_GetJoinRequests(PyCallArgs &call) {
     ...
     */
    sLog.White("FleetBound", "Handle_GetJoinRequests() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_RejectJoinRequest(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_RejectJoinRequest() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_GetFleetComposition(PyCallArgs &call) {
    sLog.White("FleetBound", "Handle_GetFleetComposition() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_GetWings(PyCallArgs &call) {
         //    self.fleet.GetWings()
    sLog.White("FleetBound", "Handle_GetWings() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_SendBroadcast(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_SendBroadcast() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_UpdateMemberInfo(PyCallArgs &call) {
     ...
     */
    sLog.White("FleetBound", "Handle_UpdateMemberInfo() size=%u", call.tuple->size() );
    //call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_GetMotd(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_GetMotd() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_LeaveFleet(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_LeaveFleet() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_MakeLeader(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_MakeLeader() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_SetBooster(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_SetBooster() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_MoveMember(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_MoveMember() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_KickMember(PyCallArgs &call) {
     ...
     */
    sLog.White("FleetBound", "Handle_KickMember() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_CreateWing(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_CreateWing() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_CreateSquad(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_CreateSquad() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_DeleteWing(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_DeleteWing() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_DeleteSquad(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_DeleteSquad() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
...
PyResult FleetBound::Handle_AddToVoiceChat(PyCallArgs &call) {
    ...
    sLog.White("FleetBound", "Handle_AddToVoiceChat() size=%u", call.tuple->size() );
    call.Dump(FLEET__DUMP);
