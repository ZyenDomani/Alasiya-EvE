...
public:
    ...
    PyRep *GetTransactions(uint32 characterID, uint32 typeID, uint32 quantity, double minPrice, double maxPrice, uint64 fromDate, int buySell, uint32 accountKey=1000, uint32 memberID=0);
