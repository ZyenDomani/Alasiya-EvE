...
enum EveAttrEnum {
    ...
    AttrWarpFactor = 21,                                //WarpFactor controls how quickly the ship can warp. (all 317 are zero)
    ...
    AttrMaxRange = 54,                                  //max distance range does not affect the to-hit equation.  (Optimal Range)
    ...
    AttrShieldPiercingChance = 123,                     //Chance of piercing the shield.
    AttrMainColor = 124,
    ...
    AttrOrbitRange = 157,                               // as stated     (some Drones - most npc dont have this)
    ...
    AttrCharisma = 164,                                 // current attribute of character on character, base on char type
    AttrIntelligence = 165,                             // current attribute of character on character, base on char type
    AttrMemory = 166,                                   // current attribute of character on character, base on char type
    ...
    AttrPerceptionBonus = 178,                          // character ancestry & bloodline bonus, saved to character
    AttrWillpowerBonus = 179,                           // character ancestry & bloodline bonus, saved to character
    ...
    AttrPropulsionGraphicID = 217,                      //The graphicID of the main propulsion system.    found in db.graphics
    ...
    AttrCharismaSkillTrainingTimeMultiplier = 223,              // not used
    AttrIntelligenceSkillTrainingTimeMultiplier = 224,          // not used
    AttrMemorySkillTrainingTimeMultiplier = 225,                // not used
    AttrPerceptionSkillTrainingTimeMultiplier = 226,            // not used
    AttrWillpowerSkillTrainingTimeMultiplier = 227,             // not used
    AttrCharismaSkillTrainingTimeMultiplierBonus = 228,         // not used
    AttrIntelligenceSkillTrainingTimeMultiplierBonus = 229,     // not used
    AttrMemorySkillTrainingTimeMultiplierBonus = 230,           // not used
    AttrPerceptionSkillTrainingTimeMultiplierBonus = 231,       // not used
    AttrWillpowerSkillTrainingTimeMultiplierBonus = 232,        // not used
    ...
    AttrGfxBoosterID = 246,                                     //Graphic ID of the boosters (mwd/ab) for some ships.  found in db.graphics
    AttrEntityAttackRange = 247,                                //The distance from a target an entity starts using its weapons.
    AttrEntityLootValueMin = 248,                               //The minimum value of any given unit of loot dropped by this entity.  Not the minimum value of all the loot, but of any given item
    AttrEntityLootValueMax = 249,
    AttrEntityLootCountMin = 250,                               //Deprecated. The minimum number of pieces of loot dropped by this entity.
    AttrEntityLootCountMax = 251,
    AttrEntitySecurityStatusKillBonus = 252,                    //How much security status is modified by for killing this entity.  Depending on the entity, this may be a positive or negative amount.
    AttrEntitySecurityStatusAggressionBonus = 253,              //The amount of security status lost of aggressing against this entity first.
    ...
    AttrShieldCapacity = 263,                                   // shield HP on the item.
    AttrShieldCharge = 264,                                     //DO NOT MESS WITH. Helper attribute for entities, stands in for the shield charge.
    AttrArmorHP = 265,                                          // armor HP on the item.
    AttrArmorDamage = 266,                                      //DO NOT MESS WITH. The amount of damage done to the entities armor hit points.
    ...
    AttrMissileStandardVelocityPecent = 400,                    //Missiles velocity multiplier
    AttrCruiseMissileVelocityPercent = 401,                     //Damage Bonus for Cruise Missiles
    AttrHeavyMissileSpeedPercent = 402,                         //Heavy missile speed percent
    AttrRocketDmgPercent = 403,                                 //Rocket Dmg Percent
    AttrTorpedoVelocityPercent = 404,                           //Torpedo velocity percent
    AttrDefenderVelocityPercent = 405,                          //Defender velocity percent
    AttrMissileFOFVelocityPercent = 406,                        //Missile FOF velocity percent
    ...
    AttrEntityEquipmentMin = 456,                       // no description...we'll use it to set missile/ewar/reppers
    AttrEntityEquipmentMax = 457,                       // no description...we'll use it to set missile/ewar/reppers
    ...
    AttrEntityCruiseSpeed = 508,                        //The speed that entities fly at when not chasing a target. (Orbit Velocity)
    ...
    AttrModifyTargetSpeedDuration = 513,                // durationAttributeID in dgmEffects
    ...
    AttrMissileVelocityBonus = 547,                             //Autogenerated skill attribute, missileVelocityBonus
    ...
    AttrWarpSpeedBonus = 601,                           //Autogenerated skill attribute, warpSpeedBonus
    ...
    AttrOptimalSigRadius = 620,                         //Preferred target signature.
    ...
    AttrCargoGroup = 629,
    AttrEntityArmorRepairDuration = 630,                //Duration between armor repair actions for entities.
    AttrEntityArmorRepairAmount = 631,                  //Amount of armor repaired per cycle for entities.
    ...
    AttrEntityShieldBoostDuration = 636,                //How long between repeats.
    AttrEntityShieldBoostAmount = 637,                  //How much the shield is boosted each duration.
    AttrEntityArmorRepairDelayChance = 638,             //Chance that an entity will delay employing armor repair.
    AttrEntityShieldBoostDelayChance = 639,             //The chance an entity will delay repeating use of its shield boosting effect if it has one.
    ...
    AttrShieldTUNEBonus = 648,                          //no description
    ...
    AttrMaxDirectionalVelocity = 661,                   //Deprecated.
    ...
    AttrEntityFlyRangeMultiplier = 779,                 //For charges, hidden attribute used by sentry guns to modify target pick range.
    ...
    AttrMinScanDeviation = 787,                         //Minimum scanning error
    AttrMaxScanDeviation = 788,                         //Maximum scan error
    AttrSpecialtyMiningAmount = 789,
    AttrReprocessingSkillType = 790,
    AttrScanAnalyzeCount = 791,                         //Number of probes needed for an analysis
    ...
    AttrActivationTargetLoss = 855,                     //Activating this module results in the temporary loss of all targets currently held or being locked.
    ...
    AttrCanJump = 861,
    AttrUsageWeighting = 862,                           //The weighting given to this type and its chance of being picked for a grouping.
    ...
    AttrEntityMaxVelocitySignatureRadiusMultiplier = 1133,      // zero rows
    ...
    AttrAI_ShouldUseTargetSwitching = 1648,             // int bool
    ...
    AttrAI_PreferredSignatureRadius = 1655,             // none
