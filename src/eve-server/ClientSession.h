...
/* session vars sent at char selection
        [PyInt 0]
        [PyDict 19 kvp]
          [PyString "genderID"]
          [PyTuple 2 items]
          ...
          [PyTuple 2 items]
            [PyNone]
            [PyIntegerVar 20000192]
          [PyString "bloodlineID"]
          [PyTuple 2 items]
            [PyNone]
            [PyInt 1]
          [PyString "corprole"]
          [PyTuple 2 items]
            [PyInt 0]
            [PyIntegerVar 180427659162419200]
          [PyString "corpid"]
          [PyTuple 2 items]
            [PyNone]
            [PyInt 1630077495]
          ...
          [PyTuple 2 items]
            [PyNone]
            [PyIntegerVar 10000015]
          [PyString "rolesAtAll"]
          [PyTuple 2 items]
            [PyInt 0]
            [PyIntegerVar 180146184118075392]
          [PyString "rolesAtBase"]
          [PyTuple 2 items]
            [PyInt 0]
            [PyIntegerVar 281475044343808]
          [PyString "allianceid"]
          [PyTuple 2 items]
            [PyNone]
            [PyInt 99001691]
