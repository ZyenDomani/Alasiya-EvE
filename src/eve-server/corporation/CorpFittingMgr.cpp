...
PyResult CorpFittingMgr::Handle_GetFittings(PyCallArgs &call)
{
    ...
    _log(CORP__CALL, "CorpFittingMgr::Handle_GetFittings()", "size= %u from '%s'", call.tuple->size(), call.client->GetName() );
...
PyResult CorpFittingMgr::Handle_SaveFitting(PyCallArgs &call)
{
    ...
    _log(CORP__CALL, "CorpFittingMgr::Handle_SaveFitting()", "size= %u from '%s'", call.tuple->size(), call.client->GetName() );
    call.Dump(CORP__CALL_DUMP);
...
PyResult CorpFittingMgr::Handle_SaveManyFittings(PyCallArgs &call)
{
    /*
        ...
        */
    _log(CORP__CALL, "CorpFittingMgr::Handle_SaveManyFittings()", "size= %u from '%s'", call.tuple->size(), call.client->GetName() );
    call.Dump(CORP__CALL_DUMP);
...
PyResult CorpFittingMgr::Handle_DeleteFitting(PyCallArgs &call)
{
    ...
    _log(CORP__CALL, "CorpFittingMgr::Handle_DeleteFitting()", "size= %u from '%s'", call.tuple->size(), call.client->GetName() );
    call.Dump(CORP__CALL_DUMP);
...
PyResult CorpFittingMgr::Handle_UpdateNameAndDescription(PyCallArgs &call)
{
    ...
    _log(CORP__CALL, "CorpFittingMgr::Handle_UpdateNameAndDescription()", "size= %u from '%s'", call.tuple->size(), call.client->GetName() );
    call.Dump(CORP__CALL_DUMP);
