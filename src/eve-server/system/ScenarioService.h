...
protected:
    ...
    PyCallable_DECL_CALL(DeleteObjects);
    PyCallable_DECL_CALL(GetEditingRoomID);
    PyCallable_DECL_CALL(WaitForObjectCreationByID);
    PyCallable_DECL_CALL(GetEditingRoomPosition);
    PyCallable_DECL_CALL(RotateSelected);
    PyCallable_DECL_CALL(JitterSelection);
    PyCallable_DECL_CALL(JitterRotationSelection);
    PyCallable_DECL_CALL(ArrangeSelection);
    PyCallable_DECL_CALL(SaveAllChanges);
    PyCallable_DECL_CALL(DeleteSelected);
    PyCallable_DECL_CALL(AddHardGroup);
    PyCallable_DECL_CALL(RenameHardGroup);
    PyCallable_DECL_CALL(RemoveAllHardGroups);
    PyCallable_DECL_CALL(RefreshSelection);
    PyCallable_DECL_CALL(AreAllSelected);
    PyCallable_DECL_CALL(SetActiveHardGroup);
    PyCallable_DECL_CALL(SetSelectedQuantity);
