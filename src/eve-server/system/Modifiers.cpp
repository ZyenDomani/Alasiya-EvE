...
void DGM_Skill_Bonus_Modifiers_Table::_Populate()
{
    ...
    sLog.Log("  Skill Modifiers", "%u skill modifier objects loaded in %.3fms", total_modifier_count, (GetTimeMSeconds() - start));
...
void DGM_Ship_Bonus_Modifiers_Table::_Populate()
{
    ...
    sLog.Log("   Ship Modifiers", "%u ship modifier objects loaded in %.3fms", total_modifier_count, (GetTimeMSeconds() - start));
...
void DGM_Implant_Modifiers_Table::_Populate()
{
    ...
    sLog.Log("Implant Modifiers", "%u implant modifier objects loaded in %.3fms", total_modifier_count, (GetTimeMSeconds() - start));
