...
const char* StaticDataMgr::GetFlagName(EVEItemFlags flag)
{
    switch (flag) {
        ...
        case flagMidSlot0:                              return "MidSlot0";
        case flagMidSlot1:                              return "MidSlot1";
        case flagMidSlot2:                              return "MidSlot2";
        case flagMidSlot3:                              return "MidSlot3";
        case flagMidSlot4:                              return "MidSlot4";
        case flagMidSlot5:                              return "MidSlot5";
        case flagMidSlot6:                              return "MidSlot6";
        case flagMidSlot7:                              return "MidSlot7";
