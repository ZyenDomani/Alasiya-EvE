...
std::string StaticDataMgr::GetFlagName(EVEItemFlags flag)
{
    switch (flag) {
        ...
        case flagCargoHold:                             return "CargoHold";
        ...
        case flagLowSlot0:                              return "LowSlot0";
        case flagLowSlot1:                              return "LowSlot1";
        case flagLowSlot2:                              return "LowSlot2";
        case flagLowSlot3:                              return "LowSlot3";
        case flagLowSlot4:                              return "LowSlot4";
        case flagLowSlot5:                              return "LowSlot5";
        case flagLowSlot6:                              return "LowSlot6";
        case flagLowSlot7:                              return "LowSlot7";
        case flagMedSlot0:                              return "MedSlot0";
        case flagMedSlot1:                              return "MedSlot1";
        case flagMedSlot2:                              return "MedSlot2";
        case flagMedSlot3:                              return "MedSlot3";
        case flagMedSlot4:                              return "MedSlot4";
        case flagMedSlot5:                              return "MedSlot5";
        case flagMedSlot6:                              return "MedSlot6";
        case flagMedSlot7:                              return "MedSlot7";
        case flagHiSlot0:                               return "HiSlot0";
        case flagHiSlot1:                               return "HiSlot1";
        case flagHiSlot2:                               return "HiSlot2";
        case flagHiSlot3:                               return "HiSlot3";
        case flagHiSlot4:                               return "HiSlot4";
        case flagHiSlot5:                               return "HiSlot5";
        case flagHiSlot6:                               return "HiSlot6";
        case flagHiSlot7:                               return "HiSlot7";
        case flagFixedSlot:                             return "FixedSlot";
        case flagFactoryBlueprint:                      return "FactoryBlueprint";
        ...
        case flagBoardingGate:                          return "BoardingGate";
        case flagCrew:                                  return "Crew";
        case flagSkillInTraining:                       return "SkillInTraining";
        case flagCorpMarket:                            return "CorpMarket";
        ...
        case flagDroneBay:                              return "DroneBay";
        case flagBooster:                               return "Booster";
        case flagImplant:                               return "Implant";
        case flagShipHangar:                            return "ShipHangar";
        case flagShipOffline:                           return "ShipOffline";
        case flagRigSlot0:                              return "RigSlot0";
        case flagRigSlot1:                              return "RigSlot1";
        case flagRigSlot2:                              return "RigSlot2";
        case flagRigSlot3:                              return "RigSlot3";
        case flagRigSlot4:                              return "RigSlot4";
        case flagRigSlot5:                              return "RigSlot5";
        case flagRigSlot6:                              return "RigSlot6";
        case flagRigSlot7:                              return "RigSlot7";
        ...
        case flagSecondaryStorage:                      return "SecondaryStorage";
        case flagCaptainsQuarters:                      return "CaptainsQuarters";
        case flagWisPromenade:                          return "WisPromenade";
        //case flagWorldSpace:                          return "WorldSpace";
        case flagSubSystem0:                            return "SubSystem0";
        case flagSubSystem1:                            return "SubSystem1";
        case flagSubSystem2:                            return "SubSystem2";
        case flagSubSystem3:                            return "SubSystem3";
        case flagSubSystem4:                            return "SubSystem4";
        ...
        case flagFleetHangar:                           return "FleetHangar";
