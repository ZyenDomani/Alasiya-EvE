...
const char* StaticDataMgr::GetFlagName(EVEItemFlags flag)
{
    switch (flag) {
        ...
        case flagMedSlot0:                              return "MidSlot0";
        case flagMedSlot1:                              return "MidSlot1";
        case flagMedSlot2:                              return "MidSlot2";
        case flagMedSlot3:                              return "MidSlot3";
        case flagMedSlot4:                              return "MidSlot4";
        case flagMedSlot5:                              return "MidSlot5";
        case flagMedSlot6:                              return "MidSlot6";
        case flagMedSlot7:                              return "MidSlot7";
