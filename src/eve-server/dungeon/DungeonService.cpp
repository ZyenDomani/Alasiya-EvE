...
PyResult DungeonService::Handle_GetArchetypes( PyCallArgs& call )
{
     ...
     */
    _log(DUNG__CALL,  "DungeonService::Handle_GetArchetypes  size: %lu", call.tuple->size());
    call.Dump(DUNG__CALL_DUMP);
...
PyResult DungeonService::Handle_DEGetDungeons( PyCallArgs& call )
{
    ...
    _log(DUNG__CALL,  "DungeonService::Handle_DEGetDungeons  size: %lu", call.tuple->size());
    call.Dump(DUNG__CALL_DUMP);
...
/*
    ...
    _log(DUNG__CALL,  "DungeonService::Handle_DEGetTemplates  size: %lu", call.tuple->size());
    call.Dump(DUNG__CALL_DUMP);
...
PyResult DungeonService::Handle_DEGetRooms( PyCallArgs& call )
{
    ...
    _log(DUNG__CALL,  "DungeonService::Handle_DEGetRooms  size: %lu", call.tuple->size());
    call.Dump(DUNG__CALL_DUMP);
...
PyResult DungeonService::Handle_DEGetRoomObjectPaletteData( PyCallArgs& call )
{
     ...
     */
    _log(DUNG__CALL,  "DungeonService::Handle_DEGetRoomObjectPaletteData  size: %lu", call.tuple->size());
    call.Dump(DUNG__CALL_DUMP);
...
PyResult DungeonService::Handle_DEGetFactions( PyCallArgs& call )
{
    /* factions = sm.RemoteSvc('dungeon').DEGetFactions()
        ...
        */
    _log(DUNG__CALL,  "DungeonService::Handle_DEGetFactions  size: %lu", call.tuple->size());
    call.Dump(DUNG__CALL_DUMP);
