...
void Profile::GetRunTimes(std::vector< double >& container, float& h, float& l, float& a)
{
    if (container.empty()) {
        h = 0.0f;
        l = 0.0f;
...
{
    switch (key) {
        case destinyProfile:       return "Destiny";   //  1,
        case mapProfile:           return "Map";       //  2,
        case clientProfile:        return "Client";    //  3,
        case npcProfile:           return "NPC";       //  4,
        case bubblesProfile:       return "Bubble";    //  5,
        case itemsProfile:         return "Item";      //  6,
        case modulesProfile:       return "Module";    //  7,
        case functionsProfile:     return "Function";  //  8,
        case dbProfile:            return "DB";        //  9,
        case shipProfile:          return "Ship";      //  10,
        case targetsProfile:       return "Target";    //  11,
        case serverProfile:        return "Server";    //  12,
        case missileProfile:       return "Missile";   //  13,
        case systemProfile:        return "System";    //  14,
        case entitySProfile:       return "EntityTic"; //  15,
        case lootProfile:          return "Loot";      //  16,
        case salvageProfile:       return "Salvage";   //  17,
        case spawnProfile:         return "Spawn";     //  18,
        case collisionProfile:     return "Collision"; //  19,
        case droneProfile:         return "Drone";     //  20,
