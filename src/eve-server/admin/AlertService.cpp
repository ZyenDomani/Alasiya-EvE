...
PyResult AlertService::Handle_BeanCount(PyCallArgs &call) {
    _log(CLIENT__WARNING, "AlertService::Handle_BeanCount(): size=%zu", call.tuple->size() );
...
{
    _log(CLIENT__WARNING, "AlertService::Handle_BeanDelivery(): size=%zu", call.tuple->size() );
    //call.Dump(CLIENT__CALL_DUMP);
...
{
    _log(CLIENT__WARNING, "AlertService::Handle_GroupBeanDelivery(): size=%zu", call.tuple->size() );
    //call.Dump(CLIENT__CALL_DUMP);
...
PyResult AlertService::Handle_SendClientStackTraceAlert(PyCallArgs &call) {
    _log(CLIENT__WARNING, "AlertService::Handle_SendClientStackTraceAlert(): size=%zu", call.tuple->size() );
    //call.Dump(CLIENT__CALL_DUMP);
