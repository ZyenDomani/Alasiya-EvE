...
typedef enum {
    ...
    factionAmmatar       = 500007,      // Amarr + Minmatar
    factionKhanid        = 500008,
    factionSyndicate     = 500009,
    factionGuristas      = 500010,      // Caldari + Gallente
    factionAngel         = 500011,      // Minmatar + Gallente (depends on skill order)
    factionBloodRaider   = 500012,      // Minmatar + Amarr
