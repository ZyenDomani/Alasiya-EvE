...
static const char* const EVEMU_REVISION = "0.9.75-allan";
static const char* const EVEMU_BUILD_DATE = "17 February 2020";
static const float EVE_Build = 3.01;     /* this is for bug tracking on my forums.  -allan 3July15 */
