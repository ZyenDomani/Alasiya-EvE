...
static const char* const EVEMU_REVISION = "0.9.13-allan";
static const char* const EVEMU_BUILD_DATE = "30 November 2017";
static const float EVE_Build = 1.97;     /* this is for bug tracking on my forums.  -allan 3July15 */
