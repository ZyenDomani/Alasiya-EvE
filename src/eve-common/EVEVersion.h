...
static const char* const EVEMU_REVISION = "0.75.01";
...
static const float Config_Version = 11.6f; /* eve-server.xml and EveServerConfig.cpp */
...
static const float Drone_AI_Version = 1.03f;
