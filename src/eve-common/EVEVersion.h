...
static const float Log_Version = 7.0;    /*  match versions here with logtypes.h and log.ini for full logging support */
...
static const char* const EVEMU_REVISION = "0.8.91-allan";
static const char* const EVEMU_BUILD_DATE = "8 March 2017";
