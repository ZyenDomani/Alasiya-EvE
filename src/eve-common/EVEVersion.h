...
static const char* const EVEMU_REVISION = "0.9.41-allan";
static const char* const EVEMU_BUILD_DATE = "04 January 2019";
static const float EVE_Build = 2.31;     /* this is for bug tracking on my forums.  -allan 3July15 */
