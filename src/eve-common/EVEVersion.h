...
static const char* const EVEMU_REVISION = "0.9.30-allan";
static const char* const EVEMU_BUILD_DATE = "27 Novemeber 2018";
...
static const float Config_Version = 8.9; /* eve-server.xml and EveServerConfig.cpp */
