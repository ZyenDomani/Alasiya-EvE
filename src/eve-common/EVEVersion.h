...
static const char* const EVEMU_REVISION = "0.9.81-allan";
static const char* const EVEMU_BUILD_DATE = "11 March 2020";
static const float EVE_Build = 3.17;     /* this is for bug tracking on my forums.  -allan 3July15 */
