...
static const char* const EVEMU_REVISION = "0.9.77-allan";
static const char* const EVEMU_BUILD_DATE = "3 March 2020";
static const float EVE_Build = 3.11;     /* this is for bug tracking on my forums.  -allan 3July15 */
