...
static const char* const EVEMU_REVISION = "0.9.33-allan";
static const char* const EVEMU_BUILD_DATE = "5 December 2018";
static const float EVE_Build = 2.25;     /* this is for bug tracking on my forums.  -allan 3July15 */
