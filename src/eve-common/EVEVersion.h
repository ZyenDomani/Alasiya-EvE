...
static const float Config_Version = 7.3; /*  match versions here with eve-server.xml and EveServerConfig.cpp for full config support */
static const float Log_Version = 6.8;    /*  match versions here with logtypes.h and log.ini for full logging support */
