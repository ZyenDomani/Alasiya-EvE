...
static const char* const EVEMU_REVISION = "0.72.89";
...
static const float Config_Version = 10.8f; /* eve-server.xml and EveServerConfig.cpp */
static const float Log_Version = 10.9f;    /* logtypes.h and log.ini */
