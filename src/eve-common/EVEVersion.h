...
static const char* const EVEMU_REVISION = "0.71.37";
static const char* const EVEMU_BUILD_DATE = "12 September 2021";
...
static const float Log_Version = 10.4;    /* logtypes.h and log.ini */
