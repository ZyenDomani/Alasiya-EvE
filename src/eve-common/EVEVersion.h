...
static const float EVE_Build = 1.67;     /* this is for bug tracking on my forums.  -allan 3July15 */
static const char* const EVEMU_REVISION = "0.8.66-allan";
static const char* const EVEMU_BUILD_DATE = "08 August 2016";
