...
static const char* const EVEMU_REVISION = "0.9.20-allan";
static const char* const EVEMU_BUILD_DATE = "24 March 2018";
static const float EVE_Build = 2.09;     /* this is for bug tracking on my forums.  -allan 3July15 */
