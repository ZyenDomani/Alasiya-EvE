...
static const char* const EVEMU_REVISION = "0.9.71-allan";
static const char* const EVEMU_BUILD_DATE = "20 January 2020";
static const float EVE_Build = 2.98;     /* this is for bug tracking on my forums.  -allan 3July15 */
