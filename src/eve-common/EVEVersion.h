...
static const char* const EVEMU_REVISION = "0.9.67-allan";
static const char* const EVEMU_BUILD_DATE = "26 August 2019";
...
static const float Log_Version = 9.4;    /* logtypes.h and log.ini */
