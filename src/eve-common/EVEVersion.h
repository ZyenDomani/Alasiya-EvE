...
static const float Config_Version = 6.9; /*  match versions here with eve-server.xml and EveServerConfig.cpp for full config support */
...
static const float EVE_Build = 1.76;     /* this is for bug tracking on my forums.  -allan 3July15 */
static const char* const EVEMU_REVISION = "0.8.74-allan";
static const char* const EVEMU_BUILD_DATE = "5 November 2016";
