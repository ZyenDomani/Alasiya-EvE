...
static const float Config_Version = 6.4; /* match versions here with eve-server.xml and EveServerConfig.cpp for full config support */
static const float Log_Version = 5.5;    /*  match versions here with logtypes.h and log.ini for full logging support */
static const float EVE_Build = 1.51;     /* this is for bug tracking on my forums.  -allan 3July15 */
static const char* const EVEMU_REVISION = "0.8.25-allan";
static const char* const EVEMU_BUILD_DATE = "11 May 2016";
