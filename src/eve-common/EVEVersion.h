...
static const float EVE_Build = 1.59;     /* this is for bug tracking on my forums.  -allan 3July15 */
static const char* const EVEMU_REVISION = "0.8.35-allan";
static const char* const EVEMU_BUILD_DATE = "30 May 2016";
