...
static const char* const EVEMU_REVISION = "0.72.55";
static const char* const EVEMU_BUILD_DATE = "18 February 2023";
...
static const float Log_Version = 10.7;    /* logtypes.h and log.ini */
