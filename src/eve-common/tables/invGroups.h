...
namespace EVEDB {
    namespace invGroups {
        typedef enum {
            ...
            Sensor_Booster_Blueprint = 223,
            Tracking_Computer_Blueprint = 224,
            ...
            Asteroid_Rogue_Drone_Frigate = 759,
            Asteroid_Rogue_Drone_Hauler = 760,
            Asteroid_Rogue_Drone_Swarm = 761,
            ...
            Mission_Thukker_Other = 827,
            Mission_Generic_Battlecruisers = 828,
            ...
            Energy_Neutralizing_Battery = 837,
            Cynosural_Generator_Array = 838,
            Cynosural_System_Jammer = 839,
            Structure_Repair_Array = 840,
            Remote_ECM_Burst = 842,
            ...
            Asteroid_Rogue_Drone_Commander_Frigate = 847,
            ...
            Hybrid_Tech_Components = 964,
            Hybrid_Component_Blueprints = 965,
            Ancient_Salvage = 966,
            Wormhole_Minerals = 967,
            Sleeper_Propulsion_Relics = 971,
            Obsolete_Probes = 972,
            Subsystem_Blueprint = 973,
            Hybrid_Polymers = 974,
            Melted_Snowballs = 976,
            Hybrid_Reactions = 977,
            Hybrid_Decryptors = 979,
            ...
            Wormhole = 988,
            Sleeper_Electronics_Relics = 990,
            Sleeper_Offensive_Relics =   991,
            Sleeper_Engineering_Relics = 992,
            Sleeper_Defensive_Relics = 993,
            Secondary_Sun = 995,
            Strategic_Cruiser_Blueprints = 996,
            Sleeper_Hull_Relics = 997,
            Territorial_Claim_Units = 1003,
            Defense_Bunkers = 1004,
            Sovereignty_Blockade_Units = 1005,
            ...
            Citadel_Cruise = 1019,
            Industrial_Upgrades =    1020,
            Military_Upgrades =  1021,
            ...
            Sovereignty_Structure_Blueprint = 1045,
            Nanite_Repair_Paste_Blueprint = 1046,
            Structure_Blueprint = 1048,
            Incursion_Sanshas_Nation_Industrial = 1051,
            Incursion_Sanshas_Nation_Capital = 1052,
            Incursion_Sanshas_Nation_Frigate = 1053,
            Incursion_Sanshas_Nation_Cruiser = 1054,
            Incursion_Sanshas_Nation_Battleship = 1056,
