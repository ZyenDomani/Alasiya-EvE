...
public:
    ...
    ClassDestructGenerator(ClassDestructGenerator&&) =delete;
    ClassDestructGenerator(const ClassDestructGenerator&) =delete;
    ClassDestructGenerator& operator=(ClassDestructGenerator&&) =delete;
    ClassDestructGenerator& operator=(const ClassDestructGenerator&) =delete;
    virtual ~ClassDestructGenerator()                   { /* do nothing here */ }
