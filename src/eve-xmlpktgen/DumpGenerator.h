...
public:
    ...
    ClassDumpGenerator(ClassDumpGenerator&&) =delete;
    ClassDumpGenerator(const ClassDumpGenerator&) =delete;
    ClassDumpGenerator& operator=(ClassDumpGenerator&&) =delete;
    ClassDumpGenerator& operator=(const ClassDumpGenerator&) =delete;
    virtual ~ClassDumpGenerator()                       { /* do nothing here */ }
