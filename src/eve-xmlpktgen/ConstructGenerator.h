...
public:
    ...
    ClassConstructGenerator(ClassConstructGenerator&&) =delete;
    ClassConstructGenerator(const ClassConstructGenerator&) =delete;
    ClassConstructGenerator& operator=(ClassConstructGenerator&&) =delete;
    ClassConstructGenerator& operator=(const ClassConstructGenerator&) =delete;
    virtual ~ClassConstructGenerator()                  { /* do nothing here */ }
