...
def LoadQuote(self, *args):
    ...
    if scrolllist:
        ...
        timeMultiSkillLabel = localization.GetByLabel('UI/ScienceAndIndustry/ScienceAndIndustryWindow/TimeMu/ltiplierSkill')
    ...
    for header, key in d:
        ...
        if key == 'materialMultiplier':
            value = localizationUtil.FormatNumeric(value, decimalPlaces=2)
